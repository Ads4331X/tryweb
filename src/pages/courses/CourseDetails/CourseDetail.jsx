  ...
  return (
    <Container className="mt-5 pt-5 mb-5 pb-5">
      <Row className={`g-4 ${css.mainRow}`}>
        <Col xs={12} lg={8}>
          <div className={css.detailContent}>
            ...
            <p className="text-secondary mt-4 fw-normal">
              ...
              magna dolores aliquyam dolores dolore. Amet erat amet et magna
            </p>
        ...
        <Col xs={12} lg={4} className={css.CourseFeatureCol}>
          <CourseFeatures />
        </Col>
      </Row>
      <Row className="g-4">
        ...
        <Col xs={12} lg={4} className={css.sidebarColumn}>
          <CourseCategories />
          <RecentCourses />
        </Col>
      </Row>
